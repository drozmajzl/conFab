...
function AlbumShow( { albums, setAlbums, setlists, setSetlists, fetchSetlists, addTrack, setAddTrack, showSideBar }){
    ...
    return(
        <div>
            ...
            <img id="album-show-cover" alt="Album Cover" className={showSideBar ? "album_cover_expand" : "album_cover"} style={{width: "20vw", height: "20vw"}} src={require(`../assets/${currentAlbum.album_cover}.jpeg`).default}></img>
